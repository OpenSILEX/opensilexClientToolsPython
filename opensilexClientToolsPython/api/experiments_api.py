...
class ExperimentsApi(object):
    ...
    def get_experiments_by_uris(
        ...
        **kwargs
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_experiments_by_uris(uris, async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.get_experiments_by_uris_with_http_info(uris, **passed_arguments, **kwargs)  # noqa: E501
        else:
            (data) = self.get_experiments_by_uris_with_http_info(uris, **passed_arguments, **kwargs)  # noqa: E501
            return data

    def get_experiments_by_uris_with_http_info(self, uris, **kwargs):  # noqa: E501
        """Get experiments URIs  # noqa: E501

          # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_experiments_by_uris_with_http_info(uris, async_req=True)
        >>> result = thread.get()
    ...
    def search_experiments(
        ...
        **kwargs
        ...
        :param list[str] funding: Search by funding
        :param list[str] order_by: List of fields to sort as an array of fieldName=asc|desc
        :param int page: Page number
        :param int page_size: Page size
        :param str accept_language: Request accepted language
        ...
        if (not isinstance(funding, list) or not isinstance(funding[0], str)) and funding != None:
            raise ValueError("Invalid value for parameter `funding`. This parameter couldn't be cast to type `List[str]`")
    ...
    def search_experiments_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['name', 'year', 'is_ended', 'species', 'factors', 'projects', 'is_public', 'facilities', 'funding', 'order_by', 'page', 'page_size', ]  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if 'funding' in params:
            query_params.append(('funding', params['funding']))  # noqa: E501
            collection_formats['funding'] = 'multi'  # noqa: E501
        if 'order_by' in params:
            query_params.append(('order_by', params['order_by']))  # noqa: E501
            collection_formats['order_by'] = 'multi'  # noqa: E501
        if 'page' in params:
    ...
    def search_funding(
        ...
        **kwargs
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.search_funding(async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str authorization: Authentication token (required)
        :param str name: Funding name regex pattern
        :param list[str] order_by: List of fields to sort as an array of fieldName=asc|desc
        :param int page: Page number
        :param int page_size: Page size
        :param str accept_language: Request accepted language
        :return: list[FundingGetDTO]
                 If the method is called asynchronously,
                 returns the request thread.
        """
        frame = inspect.currentframe()
        ...
        if kwargs.get('async_req'):
            return self.search_funding_with_http_info(**passed_arguments, **kwargs)  # noqa: E501
        else:
            (data) = self.search_funding_with_http_info(**passed_arguments, **kwargs)  # noqa: E501
            return data

    def search_funding_with_http_info(self, **kwargs):  # noqa: E501
        """Search funding  # noqa: E501

          # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.search_funding_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method search_funding" % key
                )
            params[key] = val
        del params['kwargs']

        if 'page' in params and params['page'] < 0:  # noqa: E501
            raise ValueError("Invalid value for parameter `page` when calling `search_funding`, must be a value greater than or equal to `0`")  # noqa: E501
        if 'page_size' in params and params['page_size'] < 0:  # noqa: E501
            raise ValueError("Invalid value for parameter `page_size` when calling `search_funding`, must be a value greater than or equal to `0`")  # noqa: E501
        collection_formats = {}
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='list[FundingGetDTO]',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
