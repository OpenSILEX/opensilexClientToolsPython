...
class OrganizationGetDTO(object):
    ...
    def __init__(self, uri : 'str' = None, rdf_type : 'str' = None, rdf_type_name : 'str' = None, name : 'str' = None, parents : List['NamedResourceDTOOrganizationModel'] = None, children : List['NamedResourceDTOOrganizationModel'] = None, groups : List['NamedResourceDTOGroupModel'] = None, facilities : List['NamedResourceDTOFacilityModel'] = None, sites : List['NamedResourceDTOSiteModel'] = None, experiments : List['NamedResourceDTOExperimentModel'] = None):  # noqa: E501
