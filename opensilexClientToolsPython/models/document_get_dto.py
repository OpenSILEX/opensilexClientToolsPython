...
class DocumentGetDTO(object):
    ...
    def __init__(self, uri=None, identifier=None, rdf_type=None, rdf_type_name=None, title=None, _date=None, description=None, targets=None, authors=None, language=None, format=None, keywords=None, deprecated=None):  # noqa: E501
