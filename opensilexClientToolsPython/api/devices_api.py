...
class DevicesApi(object):
    ...
    def get_device_data_provenances_with_http_info(self, uri, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            _request_timeout=params.get('_request_timeout'),
            collection_formats=collection_formats)
    def get_device_facility(self, uri, **kwargs):  # noqa: E501
    ...
    def search_device_datafiles_with_http_info(self, uri, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            _request_timeout=params.get('_request_timeout'),
            collection_formats=collection_formats)
    def search_devices(self, rdf_type : str = None, include_subtypes : bool = None, name : str = None, variable : str = None, year : int = None, existence_date : str = None, facility : str = None, brand : str = None, model : str = None, serial_number : str = None, metadata : str = None, order_by : List[str] = None, page : int = None, page_size : int = None, **kwargs):  # noqa: E501
