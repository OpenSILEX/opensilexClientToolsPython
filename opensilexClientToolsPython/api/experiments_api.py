...
class ExperimentsApi(object):
    ...
    def create_experiment(self, body : ExperimentCreationDTO = None, **kwargs):  # noqa: E501
    ...
    def delete_experiment_with_http_info(self, uri, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            _request_timeout=params.get('_request_timeout'),
            collection_formats=collection_formats)
    def export_experiment_data_list(self, uri, start_date : str = None, end_date : str = None, timezone : str = None, scientific_objects : List[str] = None, variables : List[str] = None, min_confidence : float = None, max_confidence : float = None, provenance : str = None, metadata : str = None, mode : str = None, order_by : List[str] = None, page : int = None, page_size : int = None, **kwargs):  # noqa: E501
    ...
    def get_experiments_by_ur_is_with_http_info(self, uris, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            _request_timeout=params.get('_request_timeout'),
            collection_formats=collection_formats)
    def get_used_variables1(self, uri, scientific_objects : List[str] = None, **kwargs):  # noqa: E501
    ...
    def import_csv_data1_with_http_info(self, uri, provenance, file, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            _request_timeout=params.get('_request_timeout'),
            collection_formats=collection_formats)
    def search_experiment_data_list(self, uri, start_date : str = None, end_date : str = None, timezone : str = None, scientific_objects : List[str] = None, variables : List[str] = None, min_confidence : float = None, max_confidence : float = None, provenances : List[str] = None, metadata : str = None, order_by : List[str] = None, page : int = None, page_size : int = None, **kwargs):  # noqa: E501
    ...
    def search_experiment_data_list_with_http_info(self, uri, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            _request_timeout=params.get('_request_timeout'),
            collection_formats=collection_formats)
    def search_experiment_provenances(self, uri, name : str = None, description : str = None, activity : str = None, activity_type : str = None, agent : str = None, agent_type : str = None, order_by : List[str] = None, page : int = None, page_size : int = None, **kwargs):  # noqa: E501
    ...
    def search_experiment_provenances_with_http_info(self, uri, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            _request_timeout=params.get('_request_timeout'),
            collection_formats=collection_formats)
    def search_experiments(self, name : str = None, year : int = None, is_ended : bool = None, species : List[str] = None, factors : List[str] = None, projects : List[str] = None, is_public : bool = None, facilities : List[str] = None, order_by : List[str] = None, page : int = None, page_size : int = None, **kwargs):  # noqa: E501
    ...
    def search_experiments_with_http_info(self, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            _request_timeout=params.get('_request_timeout'),
            collection_formats=collection_formats)
    def update_experiment(self, body : ExperimentCreationDTO = None, **kwargs):  # noqa: E501
    ...
    def update_experiment_with_http_info(self, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            _request_timeout=params.get('_request_timeout'),
            collection_formats=collection_formats)
    def validate_csv2(self, uri, provenance, file, **kwargs):  # noqa: E501
        """Import a CSV file for the given experiment URI and scientific object type.  # noqa: E501
