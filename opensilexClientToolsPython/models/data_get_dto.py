...
class DataGetDTO(object):
    ...
    def __init__(self, uri : 'str' = None, _date : 'str' = None, target : 'str' = None, variable : 'str' = None, value : 'object' = None, confidence : 'float' = None, provenance : 'DataProvenanceModel' = None, metadata : Dict[str, 'object'] = None, raw_data : List['object'] = None):  # noqa: E501
