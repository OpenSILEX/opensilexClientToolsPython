...
class ExperimentGetDTO(object):
    ...
    def __init__(self, uri : 'str' = None, name : 'str' = None, start_date : 'str' = None, end_date : 'str' = None, description : 'str' = None, objective : 'str' = None, species : List['str'] = None, factors : List['str'] = None, organisations : List['NamedResourceDTOInfrastructureModel'] = None, facilities : List['NamedResourceDTOInfrastructureFacilityModel'] = None, projects : List['NamedResourceDTOProjectModel'] = None, scientific_supervisors : List['str'] = None, technical_supervisors : List['str'] = None, groups : List['str'] = None, is_public : 'bool' = None):  # noqa: E501
