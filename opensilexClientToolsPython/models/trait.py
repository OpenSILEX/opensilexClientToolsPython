...
class Trait(object):
    ...
    def __init__(self, alternative_abbreviations : List['str'] = None, attribute : 'str' = None, description : 'str' = None, entity : 'str' = None, main_abbreviation : 'str' = None, name : 'str' = None, ontology_reference : 'OntologyReference' = None, status : 'str' = None, synonyms : List['str'] = None, trait_db_id : 'str' = None, trait_name : 'str' = None, xref : 'str' = None, _class : 'str' = None):  # noqa: E501
