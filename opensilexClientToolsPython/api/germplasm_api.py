...
class GermplasmApi(object):
    ...
    def get_germplasms_by_uri(
        ...
        **kwargs
        ...
        if not isinstance(body, str) and body != None:
    ...
    def search_germplasm_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['uri', 'rdf_type', 'name', 'code', 'production_year', 'species', 'variety', 'accession', 'group_of_germplasm', 'institute', 'experiment', 'metadata', 'order_by', 'page', 'page_size', ]  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def search_germplasm_groups(
        ...
        **kwargs
        ...
        if not isinstance(germplasm, str) and germplasm != None:
