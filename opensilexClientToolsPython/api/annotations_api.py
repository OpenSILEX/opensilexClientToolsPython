        ...
        **kwargs
        ...
        if body:
            try:
                try:
                    # standard type no list
                    body = AnnotationCreationDTO(body)
                except:
                    # standard type no list
                    body = AnnotationCreationDTO(**body.to_dict())
            except ValueError as e:
        ...
        if motivation:
            try:
                try:
                    ...
                    # standard type no list
                    motivation = str(**motivation.to_dict())
            except ValueError as e:
        ...
        **kwargs
        ...
        if body:
            try:
                try:
                    # standard type no list
                    body = AnnotationUpdateDTO(body)
                except:
                    # standard type no list
                    body = AnnotationUpdateDTO(**body.to_dict())
            except ValueError as e:
