...
class ProjectsApi(object):
    ...
    def create_project(self, body : ProjectCreationDTO = None, **kwargs):  # noqa: E501
    ...
    def get_projects_by_uri_with_http_info(self, uris, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            _request_timeout=params.get('_request_timeout'),
            collection_formats=collection_formats)
    def search_projects(self, name : str = None, year : int = None, keyword : str = None, financial_funding : str = None, order_by : List[str] = None, page : int = None, page_size : int = None, **kwargs):  # noqa: E501
    ...
    def search_projects_with_http_info(self, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            _request_timeout=params.get('_request_timeout'),
            collection_formats=collection_formats)
    def update_project(self, body : ProjectCreationDTO = None, **kwargs):  # noqa: E501
