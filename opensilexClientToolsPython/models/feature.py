...
class Feature(object):
    ...
    def __init__(self, type : 'str' = None, bbox : List['float'] = None, coordinates : List['float'] = None, properties : Dict[str, 'object'] = None, geometry : 'GeoJsonObject' = None, id : 'str' = None):  # noqa: E501
