...
class GermplasmGetSingleDTO(object):
    ...
    def __init__(self, uri=None, rdf_type=None, rdf_type_name=None, name=None, synonyms=None, code=None, production_year=None, description=None, species=None, species_name=None, variety=None, variety_name=None, accession=None, accession_name=None, institute=None, website=None, metadata=None):  # noqa: E501
