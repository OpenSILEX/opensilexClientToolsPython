...
class PositionsApi(object):
    ...
    def get_position(self, uri, time : str = None, **kwargs):  # noqa: E501
    ...
    def search_geospatialized_position(self, body, base_type : str = None, start_date_time : str = None, end_date_time : str = None, **kwargs):  # noqa: E501
    ...
    def search_geospatialized_position_with_http_info(self, body, **kwargs):  # noqa: E501
        ...
        all_params = ['body', 'base_type', 'start_date_time', 'end_date_time', ]  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        return self.api_client.call_api(
            ...
            _request_timeout=params.get('_request_timeout'),
            collection_formats=collection_formats)
    def search_position_history(self, target, start_date_time : str = None, end_date_time : str = None, order_by : List[str] = None, page : int = None, page_size : int = None, **kwargs):  # noqa: E501
