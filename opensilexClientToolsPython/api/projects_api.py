        ...
        if body:
            try:
                try:
                    ...
                    body = ProjectCreationDTO(body)
                except:
                    # standard type no list
                    body = ProjectCreationDTO(**body.to_dict())
        ...
        if keyword:
            try:
                try:
                    ...
                    # standard type no list
                    keyword = str(**keyword.to_dict())
            except ValueError as e:
                raise ValueError("Invalid value for parameter `keyword`. This parameter couldn't be cast to type `str` \n{0}".format(e))
                 
        if financial_funding:
            try:
                try:
                    # standard type no list
                    financial_funding = str(financial_funding)
                except:
                    # standard type no list
                    financial_funding = str(**financial_funding.to_dict())
            except ValueError as e:
