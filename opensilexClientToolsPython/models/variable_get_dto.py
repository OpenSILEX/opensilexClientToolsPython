...
class VariableGetDTO(object):
    ...
    def __init__(self, uri : 'str' = None, name : 'str' = None, alternative_name : 'str' = None, entity : 'EntityGetDTO' = None, entity_of_interest : 'NamedResourceDTO' = None, characteristic : 'CharacteristicGetDTO' = None, method : 'MethodGetDTO' = None, unit : 'UnitGetDTO' = None):  # noqa: E501
