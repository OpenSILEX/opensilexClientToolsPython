...
class GermplasmSearchFilter(object):
    ...
    def __init__(self, included_uris : List['str'] = None, order_by : List['OrderBy'] = None, page : 'int' = None, page_size : 'int' = None, lang : 'str' = None, uri : 'str' = None, name : 'str' = None, code : 'str' = None, species : 'str' = None, variety : 'str' = None, accession : 'str' = None, institute : 'str' = None, experiment : 'str' = None, metadata : 'str' = None, uris : List['str'] = None, rdf_type : 'str' = None, production_year : 'int' = None):  # noqa: E501
