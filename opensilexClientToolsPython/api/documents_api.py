        ...
        if deprecated:
            try:
                try:
                    ...
                    # standard type no list
                    deprecated = str(**deprecated.to_dict())
            except ValueError as e:
