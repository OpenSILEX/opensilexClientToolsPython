...
class DocumentsApi(object):
    ...
    def create_document(self, description, file : str = None, **kwargs):  # noqa: E501
    ...
    def get_document_metadata_with_http_info(self, uri, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            _request_timeout=params.get('_request_timeout'),
            collection_formats=collection_formats)
    def search_documents(self, rdf_type : str = None, title : str = None, _date : str = None, targets : str = None, authors : str = None, keyword : str = None, multiple : str = None, deprecated : str = None, order_by : List[str] = None, page : int = None, page_size : int = None, **kwargs):  # noqa: E501
