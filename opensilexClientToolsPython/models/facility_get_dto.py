...
class FacilityGetDTO(object):
    ...
    def __init__(self, uri : 'str' = None, rdf_type : 'str' = None, rdf_type_name : 'str' = None, name : 'str' = None, organizations : List['NamedResourceDTOOrganizationModel'] = None, sites : List['NamedResourceDTOSiteModel'] = None, address : 'FacilityAddressDTO' = None, geometry : 'GeoJsonObject' = None, relations : List['RDFObjectRelationDTO'] = None):  # noqa: E501
