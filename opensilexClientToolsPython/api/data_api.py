...
class DataApi(object):
    ...
    def get_data_list_by_targets_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['start_date', 'end_date', 'timezone', 'experiments', 'variables', 'devices', 'min_confidence', 'max_confidence', 'provenances', 'metadata', 'group_of_germplasm', 'operators', 'germplasm_uris', 'order_by', 'page', 'page_size', 'targets', ]  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
