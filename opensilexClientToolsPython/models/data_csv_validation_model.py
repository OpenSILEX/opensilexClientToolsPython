...
class DataCSVValidationModel(object):
    ...
    def __init__(self, missing_headers : List['str'] = None, empty_headers : List['int'] = None, invalid_header_ur_is : Dict[str, 'str'] = None, datatype_errors : Dict[str, 'list'] = None, uri_not_found_errors : Dict[str, 'list'] = None, invalid_uri_errors : Dict[str, 'list'] = None, missing_required_value_errors : Dict[str, 'list'] = None, invalid_value_errors : Dict[str, 'list'] = None, already_existing_uri_errors : Dict[str, 'list'] = None, duplicate_uri_errors : Dict[str, 'list'] = None, invalid_row_size_errors : Dict[str, 'list'] = None, nb_object_imported : 'int' = None, validation_token : 'str' = None, csv_header : 'CsvHeader' = None, invalid_object_errors : Dict[str, 'list'] = None, invalid_target_errors : Dict[str, 'list'] = None, invalid_date_errors : Dict[str, 'list'] = None, invalid_data_type_errors : Dict[str, 'list'] = None, invalid_experiment_errors : Dict[str, 'list'] = None, invalid_device_errors : Dict[str, 'list'] = None, device_choice_ambiguity_errors : Dict[str, 'list'] = None, duplicated_data_errors : Dict[str, 'list'] = None, duplicated_object_errors : Dict[str, 'list'] = None, duplicated_target_errors : Dict[str, 'list'] = None, duplicated_experiment_errors : Dict[str, 'list'] = None, duplicated_device_errors : Dict[str, 'list'] = None, headers : List['str'] = None, headers_labels : List['str'] = None, nb_lines_imported : 'int' = None, nb_lines_to_import : 'int' = None, validation_step : 'bool' = None, insertion_step : 'bool' = None, valid_csv : 'bool' = None, too_large_dataset : 'bool' = None, error_message : 'str' = None):  # noqa: E501
