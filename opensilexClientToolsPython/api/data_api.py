...
class DataApi(object):
    ...
    def count_data_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['start_date', 'end_date', 'timezone', 'experiments', 'targets', 'variables', 'devices', 'min_confidence', 'max_confidence', 'provenances', 'metadata', 'operators', ]  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        **kwargs
        ...
        if body:
            try:
                try:
                    # standard type no list
                    body = ProvenanceCreationDTO(body)
                except:
                    # standard type no list
                    body = ProvenanceCreationDTO(**body.to_dict())
            except ValueError as e:
        ...
        **kwargs
        ...
        if body:
            try:
                try:
                    # standard type no list
                    body = DataSearchDTO(body)
                except:
                    # standard type no list
                    body = DataSearchDTO(**body.to_dict())
            except ValueError as e:
        ...
        **kwargs
        ...
        if with_raw_data:
            try:
                try:
                    # standard type no list
                    with_raw_data = bool(with_raw_data)
                except:
                    # standard type no list
                    with_raw_data = bool(**with_raw_data.to_dict())
            except ValueError as e:
    ...
    def get_data_list_by_targets_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['start_date', 'end_date', 'timezone', 'experiments', 'variables', 'devices', 'min_confidence', 'max_confidence', 'provenances', 'metadata', 'group_of_germplasm', 'operators', 'order_by', 'page', 'page_size', 'targets', ]  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        **kwargs
        ...
        if calculated_only:
            try:
                try:
                    # standard type no list
                    calculated_only = bool(calculated_only)
                except:
                    # standard type no list
                    calculated_only = bool(**calculated_only.to_dict())
            except ValueError as e:
        ...
        if scaled_width:
            try:
                try:
                    ...
                    # standard type no list
                    scaled_width = int(**scaled_width.to_dict())
            except ValueError as e:
        ...
        if scaled_height:
            try:
                try:
                    ...
                    # standard type no list
                    scaled_height = int(**scaled_height.to_dict())
            except ValueError as e:
    ...
    def post_data_file_paths(
        ...
        **kwargs
        ...
        try:
            try:
                body = [
                    DataFilePathCreationDTO(x)
                    for x in body
                ]
            except:
                body = [
                    DataFilePathCreationDTO(**x.to_dict())
                    for x in body
                ]
        except ValueError as e:
        ...
        **kwargs
        ...
        if body:
            try:
                try:
                    # standard type no list
                    body = DataUpdateDTO(body)
                except:
                    # standard type no list
                    body = DataUpdateDTO(**body.to_dict())
            except ValueError as e:
        ...
        **kwargs
        ...
        if body:
            try:
                try:
                    # standard type no list
                    body = DataConfidenceDTO(body)
                except:
                    # standard type no list
                    body = DataConfidenceDTO(**body.to_dict())
            except ValueError as e:
        ...
        **kwargs
        ...
        if body:
            try:
                try:
                    # standard type no list
                    body = ProvenanceUpdateDTO(body)
                except:
                    # standard type no list
                    body = ProvenanceUpdateDTO(**body.to_dict())
            except ValueError as e:
