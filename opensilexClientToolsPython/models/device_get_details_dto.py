...
class DeviceGetDetailsDTO(object):
    ...
    def __init__(self, uri : 'str' = None, rdf_type : 'str' = None, rdf_type_name : 'str' = None, name : 'str' = None, brand : 'str' = None, constructor_model : 'str' = None, serial_number : 'str' = None, person_in_charge : 'str' = None, start_up : 'str' = None, removal : 'str' = None, relations : List['RDFObjectRelationDTO'] = None, description : 'str' = None, metadata : Dict[str, 'str'] = None):  # noqa: E501
