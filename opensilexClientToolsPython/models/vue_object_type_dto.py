...
class VueObjectTypeDTO(object):
    ...
    def __init__(self, uri : 'str' = None, name : 'str' = None, short_uri : 'str' = None, input_component : 'str' = None, input_components_by_property : Dict[str, 'str'] = None, view_component : 'str' = None, rdf_type : 'RDFTypeTranslatedDTO' = None):  # noqa: E501
