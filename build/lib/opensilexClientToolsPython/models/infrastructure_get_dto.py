...
class InfrastructureGetDTO(object):
    ...
    def __init__(self, uri=None, rdf_type=None, rdf_type_name=None, name=None, parents=None, children=None, groups=None, facilities=None, sites=None, experiments=None):  # noqa: E501
