...
class EventCreationDTO(object):
    ...
    def __init__(self, uri : 'str' = None, rdf_type : 'str' = None, start : 'str' = None, end : 'str' = None, is_instant : 'bool' = None, description : 'str' = None, targets : List['str'] = None, relations : List['RDFObjectRelationDTO'] = None):  # noqa: E501
