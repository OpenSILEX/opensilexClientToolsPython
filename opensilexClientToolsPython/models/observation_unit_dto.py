...
class ObservationUnitDTO(object):
    ...
    def __init__(self, block_number=None, entry_number=None, entry_type=None, germplasm_db_id=None, germplasm_name=None, observation_level=None, observation_levels=None, observation_unit_db_id=None, observation_unit_xref=None, observations=None, plant_number=None, plot_number=None, position_coordinate_x=None, position_coordinate_x_type=None, position_coordinate_y=None, position_coordinate_y_type=None, program_name=None, replicate=None, study_db_id=None, study_location=None, study_location_db_id=None, study_name=None, treatments=None):  # noqa: E501
