...
class CSVURINotFoundError(object):
    ...
    def __init__(self, row_index : 'int' = None, col_index : 'int' = None, header : 'str' = None, value : 'str' = None, rdf_type : 'str' = None, object_uri : 'str' = None, message : 'str' = None):  # noqa: E501
