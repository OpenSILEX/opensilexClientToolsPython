...
class FactorDetailsGetDTO(object):
    ...
    def __init__(self, uri : 'str' = None, name : 'str' = None, category : 'str' = None, description : 'str' = None, levels : List['FactorLevelGetDTO'] = None, exact_match : List['str'] = None, close_match : List['str'] = None, broad_match : List['str'] = None, narrow_match : List['str'] = None, experiment : 'str' = None):  # noqa: E501
