...
class BRAPIApi(object):
        ...
        **kwargs
        ...
        if germplasm_db_id:
            try:
                try:
                    # standard type no list
                    germplasm_db_id = str(germplasm_db_id)
                except:
                    # standard type no list
                    germplasm_db_id = str(**germplasm_db_id.to_dict())
            except ValueError as e:
        ...
        if germplasm_pui:
            try:
                try:
                    # standard type no list
                    germplasm_pui = str(germplasm_pui)
                except:
                    # standard type no list
                    germplasm_pui = str(**germplasm_pui.to_dict())
            except ValueError as e:
        ...
        if germplasm_name:
            try:
                try:
                    # standard type no list
                    germplasm_name = str(germplasm_name)
                except:
                    # standard type no list
                    germplasm_name = str(**germplasm_name.to_dict())
            except ValueError as e:
        ...
        if common_crop_name:
            try:
                try:
                    # standard type no list
                    common_crop_name = str(common_crop_name)
                except:
                    # standard type no list
                    common_crop_name = str(**common_crop_name.to_dict())
            except ValueError as e:
    ...
    def get_observation_units(
        ...
        **kwargs
        ...
        try:
            try:
                study_db_id = str(study_db_id)
            except:
                study_db_id = str(**study_db_id.to_dict())
        except ValueError as e:
        ...
        if observation_level:
            try:
                try:
                    ...
                    # standard type no list
                    observation_level = str(**observation_level.to_dict())
            except ValueError as e:
            ...
            try:
                try:
                    ...
                    observation_variable_db_ids = [
                        str(x)
                        for x in observation_variable_db_ids
                    ]
                except:
                    # standard type list
                    observation_variable_db_ids = [
        ...
        if sort_order:
            try:
                try:
                    ...
                    # standard type no list
                    sort_order = str(**sort_order.to_dict())
            except ValueError as e:
    ...
    def get_variable_details(
        ...
        **kwargs
        ...
        try:
            try:
                observation_variable_db_id = str(observation_variable_db_id)
            except:
                observation_variable_db_id = str(**observation_variable_db_id.to_dict())
        except ValueError as e:
