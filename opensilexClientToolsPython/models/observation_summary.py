...
class ObservationSummary(object):
    ...
    def __init__(self, collector=None, observation_db_id=None, observation_time_stamp=None, observation_variable_db_id=None, observation_variable_name=None, season=None):  # noqa: E501
