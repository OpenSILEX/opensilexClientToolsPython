...
**no_parent_errors** | **dict(str, list[CSVCell])** |  | [optional] 
**boucle_errors** | **dict(str, list[CSVCell])** |  | [optional] 
**linked_sibbling_errors** | **dict(str, list[CSVCell])** |  | [optional] 
**short_circuit_errors** | **dict(str, list[CSVCell])** |  | [optional] 
...
**type_errors** | **dict(str, list[CSVCell])** |  | [optional] 
