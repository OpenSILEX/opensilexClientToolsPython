...
class ExperimentsApi(object):
    ...
    def search_experiment_provenances_with_http_info(self, uri, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            _request_timeout=params.get('_request_timeout'),
            collection_formats=collection_formats)
    def search_experiments(self, name : str = None, year : int = None, is_ended : bool = None, species : List[str] = None, factors : List[str] = None, projects : List[str] = None, is_public : bool = None, order_by : List[str] = None, page : int = None, page_size : int = None, **kwargs):  # noqa: E501
