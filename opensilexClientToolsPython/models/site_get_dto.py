...
class SiteGetDTO(object):
    ...
    def __init__(self, uri : 'str' = None, rdf_type : 'str' = None, rdf_type_name : 'str' = None, name : 'str' = None, address : 'SiteAddressDTO' = None, organizations : List['NamedResourceDTOInfrastructureModel'] = None, facilities : List['NamedResourceDTOInfrastructureFacilityModel'] = None, groups : List['NamedResourceDTOGroupModel'] = None, geometry : 'GeoJsonObject' = None):  # noqa: E501
