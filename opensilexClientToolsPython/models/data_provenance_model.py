...
class DataProvenanceModel(object):
    ...
    def __init__(self, uri : 'str' = None, prov_used : List['ProvEntityModel'] = None, prov_was_associated_with : List['ProvEntityModel'] = None, settings : Dict[str, 'object'] = None, experiments : List['str'] = None):  # noqa: E501
