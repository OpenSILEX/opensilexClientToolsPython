...
class FrontConfigDTO(object):
    ...
    def __init__(self,
        ...
        dashboard : 'DashboardConfigDTO' = None,
        gdpr_file_is_configured : 'bool' = None,
        matomo : 'MatomoConfigDTO' = None,
        notification_message : 'Dict[str, str]' = None,
        notification_color_theme : 'str' = None,
        notification_end_date : 'str' = None):  # noqa: E501
