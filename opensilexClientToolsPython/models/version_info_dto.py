...
class VersionInfoDTO(object):
    ...
    def __init__(self, title : 'str' = None, version : 'str' = None, description : 'str' = None, contact : 'ApiContactInfoDTO' = None, license : 'ApiLicenseInfoDTO' = None, modules_version : List['ApiModulesInfo'] = None, external_docs : 'ApiExternalDocsDTO' = None, api_docs : 'ApiExternalDocsDTO' = None, git_commit : 'ApiGitCommitDTO' = None, github_page : 'str' = None):  # noqa: E501
