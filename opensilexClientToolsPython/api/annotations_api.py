...
class AnnotationsApi(object):
    ...
    def count_annotations(self, target : str = None, **kwargs):  # noqa: E501
    ...
    def create_annotation(self, body : AnnotationCreationDTO = None, **kwargs):  # noqa: E501
    ...
    def get_annotation_with_http_info(self, uri, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            _request_timeout=params.get('_request_timeout'),
            collection_formats=collection_formats)
    def search_annotations(self, description : str = None, target : str = None, motivation : str = None, author : str = None, order_by : List[str] = None, page : int = None, page_size : int = None, **kwargs):  # noqa: E501
    ...
    def search_annotations_with_http_info(self, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            _request_timeout=params.get('_request_timeout'),
            collection_formats=collection_formats)
    def search_motivations(self, name : str = None, order_by : List[str] = None, page : int = None, page_size : int = None, **kwargs):  # noqa: E501
    ...
    def search_motivations_with_http_info(self, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            _request_timeout=params.get('_request_timeout'),
            collection_formats=collection_formats)
    def update_annotation(self, body : AnnotationUpdateDTO = None, **kwargs):  # noqa: E501
