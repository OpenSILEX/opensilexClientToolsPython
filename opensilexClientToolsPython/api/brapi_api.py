...
class BRAPIApi(object):
    ...
    def get_calls(self, page : int = None, page_size : int = None, data_type : str = None, **kwargs):  # noqa: E501
    ...
    def get_germplasm_by_search(self, germplasm_db_id : str = None, germplasm_pui : str = None, germplasm_name : str = None, common_crop_name : str = None, page : int = None, page_size : int = None, **kwargs):  # noqa: E501
    ...
    def get_germplasm_by_search_with_http_info(self, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            _request_timeout=params.get('_request_timeout'),
            collection_formats=collection_formats)
    def get_observation_units(self, study_db_id, observation_level : str = None, page_size : int = None, page : int = None, **kwargs):  # noqa: E501
    ...
    def get_observation_units_with_http_info(self, study_db_id, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            _request_timeout=params.get('_request_timeout'),
            collection_formats=collection_formats)
    def get_observation_variables(self, study_db_id, page_size : int = None, page : int = None, **kwargs):  # noqa: E501
    ...
    def get_observation_variables_with_http_info(self, study_db_id, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            _request_timeout=params.get('_request_timeout'),
            collection_formats=collection_formats)
    def get_observations(self, study_db_id, observation_variable_db_ids : List[str] = None, page_size : int = None, page : int = None, **kwargs):  # noqa: E501
    ...
    def get_observations_with_http_info(self, study_db_id, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            _request_timeout=params.get('_request_timeout'),
            collection_formats=collection_formats)
    def get_studies(self, study_db_id : str = None, active : str = None, sort_by : str = None, sort_order : str = None, page : int = None, page_size : int = None, **kwargs):  # noqa: E501
    ...
    def get_studies_with_http_info(self, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            _request_timeout=params.get('_request_timeout'),
            collection_formats=collection_formats)
    def get_studies_search(self, study_db_id : str = None, active : str = None, sort_by : str = None, sort_order : str = None, page_size : int = None, page : int = None, **kwargs):  # noqa: E501
        """Retrieve studies information  # noqa: E501
    ...
    def get_variable_details_with_http_info(self, observation_variable_db_id, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            _request_timeout=params.get('_request_timeout'),
            collection_formats=collection_formats)
    def get_variables_list(self, observation_variable_db_id : str = None, page_size : int = None, page : int = None, **kwargs):  # noqa: E501
