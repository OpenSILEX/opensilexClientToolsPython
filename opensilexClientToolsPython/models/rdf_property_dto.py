...
class RDFPropertyDTO(object):
    ...
    def __init__(self, uri : 'str' = None, domain : 'str' = None, range : 'str' = None, parent : 'str' = None, rdf_type : 'str' = None, name_translations : Dict[str, 'str'] = None, comment_translations : Dict[str, 'str'] = None):  # noqa: E501
