...
class GermplasmApi(object):
    ...
    def get_germplasm_group_by_ur_is(
        self,
        uris : 'List[str]',
        **kwargs
    ):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_germplasm_group_by_ur_is(uris, async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.get_germplasm_group_by_ur_is_with_http_info(uris, **passed_arguments, **kwargs)  # noqa: E501
        else:
            (data) = self.get_germplasm_group_by_ur_is_with_http_info(uris, **passed_arguments, **kwargs)  # noqa: E501
            return data

    def get_germplasm_group_by_ur_is_with_http_info(self, uris, **kwargs):  # noqa: E501
        """Get germplasm groups by their URIs  # noqa: E501

          # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_germplasm_group_by_ur_is_with_http_info(uris, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_germplasm_group_by_ur_is" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('uris' not in params or
                params['uris'] is None):
            raise ValueError("Missing the required parameter `uris` when calling `get_germplasm_group_by_ur_is`")  # noqa: E501
    ...
    def search_germplasm_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['uri', 'rdf_type', 'name', 'code', 'production_year', 'species', 'variety', 'accession', 'group_of_germplasm', 'institute', 'experiment', 'parent_germplasms', 'parent_germplasms_m', 'parent_germplasms_f', 'metadata', 'order_by', 'page', 'page_size', ]  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
