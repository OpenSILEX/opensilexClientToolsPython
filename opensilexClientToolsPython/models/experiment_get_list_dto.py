...
class ExperimentGetListDTO(object):
    ...
    def __init__(self, uri : 'str' = None, name : 'str' = None, start_date : 'str' = None, end_date : 'str' = None, description : 'str' = None, objective : 'str' = None, species : List['str'] = None, is_public : 'bool' = None):  # noqa: E501
