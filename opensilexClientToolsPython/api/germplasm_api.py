...
class GermplasmApi(object):
        ...
        **kwargs
        ...
        if body:
            try:
                try:
                    # standard type no list
                    body = GermplasmGroupCreationDTO(body)
                except:
                    # standard type no list
                    body = GermplasmGroupCreationDTO(**body.to_dict())
            except ValueError as e:
    ...
    def search_germplasm(
        ...
        **kwargs
        ...
        if group_of_germplasm:
            try:
                try:
                    # standard type no list
                    group_of_germplasm = str(group_of_germplasm)
                except:
                    # standard type no list
                    group_of_germplasm = str(**group_of_germplasm.to_dict())
            except ValueError as e:
        ...
        **kwargs
        ...
        if body:
            try:
                try:
                    # standard type no list
                    body = GermplasmGroupUpdateDTO(body)
                except:
                    # standard type no list
                    body = GermplasmGroupUpdateDTO(**body.to_dict())
            except ValueError as e:
