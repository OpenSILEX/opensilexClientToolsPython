...
class ScientificObjectDetailDTO(object):
    ...
    def __init__(self, uri=None, rdf_type=None, rdf_type_name=None, name=None, parent=None, parent_name=None, factor_level=None, relations=None, geometry=None):  # noqa: E501
