...
class VariableCreationDTO(object):
    ...
    def __init__(self, uri : 'str' = None, name : 'str' = None, alternative_name : 'str' = None, description : 'str' = None, entity : 'str' = None, entity_of_interest : 'str' = None, characteristic : 'str' = None, trait : 'str' = None, trait_name : 'str' = None, method : 'str' = None, unit : 'str' = None, species : List['str'] = None, datatype : 'str' = None, time_interval : 'str' = None, sampling_interval : 'str' = None, exact_match : List['str'] = None, close_match : List['str'] = None, broad_match : List['str'] = None, narrow_match : List['str'] = None):  # noqa: E501
