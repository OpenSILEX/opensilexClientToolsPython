...
class DeviceGetDTO(object):
    ...
    def __init__(self, uri=None, rdf_type=None, rdf_type_name=None, name=None, brand=None, constructor_model=None, serial_number=None, person_in_charge=None, start_up=None, removal=None, relations=None, description=None):  # noqa: E501
