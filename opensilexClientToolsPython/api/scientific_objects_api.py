...
class ScientificObjectsApi(object):
    ...
    def export_csv(
        self,
        body : 'ScientificObjectSearchDTO' = None,
        **kwargs
    ):  # noqa: E501
        ...
        if body:
            try:
                try:
                    # standard type no list
                    body = ScientificObjectSearchDTO(body)
                except:
                    # standard type no list
                    body = ScientificObjectSearchDTO(**body.to_dict())
            except ValueError as e:
                raise ValueError("Invalid value for parameter `body`. This parameter couldn't be cast to type `ScientificObjectSearchDTO` \n{0}".format(e))
