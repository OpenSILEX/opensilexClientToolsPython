...
class ThemeConfigDTO(object):
    ...
    def __init__(self, has_style : 'bool' = None, fonts : List['FontConfigDTO'] = None, icon_classes_rdf : Dict[str, 'str'] = None, component_overrides : Dict[str, 'str'] = None):  # noqa: E501
