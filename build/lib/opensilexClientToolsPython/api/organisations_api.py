...
class OrganisationsApi(object):
    ...
    def create_infrastructure_team(self, **kwargs):  # noqa: E501
        """Create a team  # noqa: E501

          # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_infrastructure_team(async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str authorization: Authentication token (required)
        :param InfrastructureTeamDTO body: Team description
        :param str accept_language: Request accepted language
        :return: ObjectUriResponse
                 If the method is called asynchronously,
                 returns the request thread.
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.create_infrastructure_team_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.create_infrastructure_team_with_http_info(**kwargs)  # noqa: E501
            return data

    def create_infrastructure_team_with_http_info(self, **kwargs):  # noqa: E501
        """Create a team  # noqa: E501

          # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_infrastructure_team_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method create_infrastructure_team" % key
                )
            params[key] = val
        del params['kwargs']
    ...
    def delete_infrastructure_team(self, uri, **kwargs):  # noqa: E501
        """Delete a team  # noqa: E501

          # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_infrastructure_team(uri, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str uri: Team URI (required)
        :param str authorization: Authentication token (required)
        :param str accept_language: Request accepted language
        :return: ObjectUriResponse
                 If the method is called asynchronously,
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.delete_infrastructure_team_with_http_info(uri, **kwargs)  # noqa: E501
        else:
            (data) = self.delete_infrastructure_team_with_http_info(uri, **kwargs)  # noqa: E501
            return data

    def delete_infrastructure_team_with_http_info(self, uri, **kwargs):  # noqa: E501
        """Delete a team  # noqa: E501

          # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_infrastructure_team_with_http_info(uri, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method delete_infrastructure_team" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'uri' is set
        if ('uri' not in params or
                params['uri'] is None):
            raise ValueError("Missing the required parameter `uri` when calling `delete_infrastructure_team`")  # noqa: E501
    ...
    def get_infrastructure_team(self, uri, **kwargs):  # noqa: E501
        """Get a team  # noqa: E501

          # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_infrastructure_team(uri, async_req=True)
        >>> result = thread.get()
        ...
        :param str authorization: Authentication token (required)
        :param str accept_language: Request accepted language
        :return: InfrastructureTeamDTO
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_infrastructure_team_with_http_info(uri, **kwargs)  # noqa: E501
        else:
            (data) = self.get_infrastructure_team_with_http_info(uri, **kwargs)  # noqa: E501
            return data

    def get_infrastructure_team_with_http_info(self, uri, **kwargs):  # noqa: E501
        """Get a team  # noqa: E501

          # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_infrastructure_team_with_http_info(uri, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_infrastructure_team" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'uri' is set
        if ('uri' not in params or
                params['uri'] is None):
            raise ValueError("Missing the required parameter `uri` when calling `get_infrastructure_team`")  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='InfrastructureTeamDTO',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def update_infrastructure_team(self, **kwargs):  # noqa: E501
        """Update a team  # noqa: E501

          # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_infrastructure_team(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.update_infrastructure_team_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.update_infrastructure_team_with_http_info(**kwargs)  # noqa: E501
            return data

    def update_infrastructure_team_with_http_info(self, **kwargs):  # noqa: E501
        """Update a team  # noqa: E501

          # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_infrastructure_team_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method update_infrastructure_team" % key
                )
            params[key] = val
        del params['kwargs']
