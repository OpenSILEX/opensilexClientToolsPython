...
class AuthenticationApi(object):
        ...
        if body:
            try:
                try:
                    ...
                    body = AuthenticationDTO(body)
                except:
                    # standard type no list
                    body = AuthenticationDTO(**body.to_dict())
        ...
        **kwargs
        ...
        try:
            try:
                ...
                identifier = str(**identifier.to_dict())
        except ValueError as e:
    ...
    def renew_password(
        ...
        **kwargs
        ...
        try:
            try:
                renew_token = str(renew_token)
            except:
                renew_token = str(**renew_token.to_dict())
        except ValueError as e:
