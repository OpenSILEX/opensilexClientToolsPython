...
class OrganizationsApi(object):
    ...
    def get_facilities_with_geometry(
        self,
        end_date_time : 'str' = None,
        **kwargs
    ):  # noqa: E501
        """Get only a list of facilities with a position (address/spatial coordinates  # noqa: E501

          # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_facilities_with_geometry(async_req=True)
        >>> result = thread.get()
        ...
        :param str accept_language: Request accepted language
        :return: list[FacilityGetWithGeometryDTO]
                 If the method is called asynchronously,
                 returns the request thread.
        """
        frame = inspect.currentframe()
        ...
        if kwargs.get('async_req'):
            return self.get_facilities_with_geometry_with_http_info(**passed_arguments, **kwargs)  # noqa: E501
        else:
            (data) = self.get_facilities_with_geometry_with_http_info(**passed_arguments, **kwargs)  # noqa: E501
            return data

    def get_facilities_with_geometry_with_http_info(self, **kwargs):  # noqa: E501
        """Get only a list of facilities with a position (address/spatial coordinates  # noqa: E501

          # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_facilities_with_geometry_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['end_date_time', ]  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_facilities_with_geometry" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api(
            '/core/facilities/with_location', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='list[FacilityGetWithGeometryDTO]',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def get_sites_with_location(
        ...
        **kwargs
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_sites_with_location(async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.get_sites_with_location_with_http_info(**passed_arguments, **kwargs)  # noqa: E501
        else:
            (data) = self.get_sites_with_location_with_http_info(**passed_arguments, **kwargs)  # noqa: E501
            return data

    def get_sites_with_location_with_http_info(self, **kwargs):  # noqa: E501
        """Get only the list of sites with a location  # noqa: E501

          # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_sites_with_location_with_http_info(async_req=True)
        >>> result = thread.get()
    ...
    def search_organizations(
        ...
        type : 'str' = None,
        parent_organization_uri : 'str' = None,
        facility_uri : 'str' = None,
        **kwargs
    ):  # noqa: E501
        ...
        if not isinstance(type, str) and type != None:
            raise ValueError("Invalid value for parameter `type`. This parameter couldn't be cast to type `str`")
                 
        if not isinstance(parent_organization_uri, str) and parent_organization_uri != None:
            raise ValueError("Invalid value for parameter `parent_organization_uri`. This parameter couldn't be cast to type `str`")
                 
        if not isinstance(facility_uri, str) and facility_uri != None:
            raise ValueError("Invalid value for parameter `facility_uri`. This parameter couldn't be cast to type `str`")
    ...
    def search_organizations_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['pattern', 'organisation_uris', 'type', 'parent_organization_uri', 'facility_uri', ]  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
