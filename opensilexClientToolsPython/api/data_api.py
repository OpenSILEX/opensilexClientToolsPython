...
class DataApi(object):
    ...
    def add_list_data(
        ...
        **kwargs
        ...
        if not isinstance(body, DataCreationDTO) and body != None:
    ...
    def count_datafiles(
        ...
        **kwargs
        ...
        if not isinstance(device, str) and device != None:
    ...
    def post_data_file_paths(
        ...
        **kwargs
        ...
        if not isinstance(body, DataFilePathCreationDTO) and body != None:
