...
class VueRDFTypeDTO(object):
    ...
    def __init__(self, uri : 'str' = None, name : 'str' = None, comment : 'str' = None, parent : 'str' = None, icon : 'str' = None, name_translations : Dict[str, 'str'] = None, comment_translations : Dict[str, 'str'] = None, is_abstract : 'bool' = None, data_properties : List['VueRDFTypePropertyDTO'] = None, object_properties : List['VueRDFTypePropertyDTO'] = None, properties_order : List['str'] = None):  # noqa: E501
