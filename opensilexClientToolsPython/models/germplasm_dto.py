...
class GermplasmDTO(object):
    ...
    def __init__(self, accession_number : 'str' = None, acquisition_date : 'str' = None, additional_info : 'str' = None, biological_status_of_accession_code : 'str' = None, biological_status_of_accession_description : 'str' = None, breeding_method_db_id : 'str' = None, collection : 'str' = None, common_crop_name : 'str' = None, country_of_origin_code : 'str' = None, default_display_name : 'str' = None, documentation_url : 'str' = None, donors : List['object'] = None, external_references : List['object'] = None, genus : 'str' = None, germplasm_db_id : 'str' = None, germplasm_name : 'str' = None, germplasm_origin : List['object'] = None, germplasm_preprocessing : 'str' = None, institute_code : 'str' = None, institute_name : 'str' = None, pedigree : 'str' = None, seed_source : 'str' = None, seed_source_description : 'str' = None, species : 'str' = None, species_authority : 'str' = None, storage_types : List['object'] = None, subtaxa : 'str' = None, subtaxa_authority : 'str' = None, synonyms : List['object'] = None, taxon_ids : List['object'] = None):  # noqa: E501
