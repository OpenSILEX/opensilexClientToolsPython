...
class MoveDetailsDTO(object):
    ...
    def __init__(self, uri=None, rdf_type=None, rdf_type_name=None, start=None, end=None, is_instant=None, description=None, targets=None, author=None, relations=None, _from=None, to=None, targets_positions=None):  # noqa: E501
    ...
    def targets_positions(self):
        ...
        :rtype: list[ConcernedItemPositionGetDTO]
        """
    ...
    def targets_positions(self, targets_positions):
        ...
        :type: list[ConcernedItemPositionGetDTO]
        """
