...
class PositionGetDTO(object):
    ...
    def __init__(self, event : 'str' = None, move_time : 'str' = None, _from : 'InfrastructureFacilityNamedDTO' = None, to : 'InfrastructureFacilityNamedDTO' = None, position : 'PositionGetDetailDTO' = None):  # noqa: E501
